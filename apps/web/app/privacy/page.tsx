  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
        ...
        Google-аккаунт). Эти сервисы не используют ваши данные в собственных целях. Место
        физического хранения данных уточняется — актуальная информация будет добавлена в эту
        политику.
      </p>
