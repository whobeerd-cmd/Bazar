...
-- Категории бизнес-справочника — см. миграции 0019, 0020.
insert into public.business_categories (name, slug, sort_order, group_label) values
  ('Кафе и рестораны', 'kafe-i-restorany', 10, 'Еда и напитки'),
  ...
  ('Продуктовые магазины', 'produktovye-magaziny', 50, 'Еда и напитки'),
  ...
  ('Автосервисы', 'avtoservisy', 310, 'Авто'),
  ...
  ('Мебель и интерьер', 'mebel-i-interer-biznes', 460, 'Стройка и ремонт'),
  ...
  ('Другое', 'drugoe-biznes', 9999, 'Другое')
on conflict (slug) do nothing;
